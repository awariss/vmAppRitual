    ...
    render() {
        switch(this.props.page) {
            ...
            case 5:
                return <React.Fragment>
                    <p className="textik">
                        Samozřejmě by bylo hloupé čekat, že se mi všechno líbilo. Ale i to zjištění, že se mě něco netýká, mi docela pomohlo si věci srovnat. Vlastně si část těch věcí srovnávám ještě teď v průběhu roku, když nám začaly schůzky...
                    </p>
                    <br />
                    <p className="textik">
